...
_cache = EnhancedCacheManager()

# Try to import metrics, fallback if not available
try:
    from .metrics import metrics_collector
    METRICS_AVAILABLE = True
except ImportError:
    METRICS_AVAILABLE = False
    print("⚠️ Metrics not available in health check")

    # Define dummy metrics_collector
    class DummyMetricsCollector:
        def update_service_health(self, *args, **kwargs): pass
        def update_db_connections(self, *args, **kwargs): pass
        def record_db_query(self, *args, **kwargs): pass
        def update_cache_size(self, *args, **kwargs): pass
    ...
    def _check_cache(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'l2_memory': l2.get('memory_used', 'n/a'),
                'timestamp': datetime.utcnow().isoformat()
            }
        except Exception as e:
            return {
