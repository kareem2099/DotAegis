...
# Try to import JSON logger, fallback to basic logging if not available
try:
    from pythonjsonlogger import jsonlogger
    JSON_LOGGER_AVAILABLE = True
except ImportError:
    JSON_LOGGER_AVAILABLE = False
    print("⚠️ python-json-logger not available, using basic logging")
...
class StructuredLogger:
    ...
    def _get_formatter(self):
        ...
        if os.getenv('LOG_FORMAT') == 'json' and JSON_LOGGER_AVAILABLE:
